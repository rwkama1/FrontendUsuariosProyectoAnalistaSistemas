...
@Component({
    selector: 'verordentallercambiada',
    templateUrl: './verordentallercambiada.html'
})
export class VerOrdenTallerCambiadaComponent implements OnInit {
    verot

    ordentaller = JSON.parse(localStorage['ordentallercambiada']) as OrdenTaller;
