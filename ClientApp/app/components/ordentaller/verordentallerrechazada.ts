...
@Component({
    selector: 'verordentallerrechazada',
    templateUrl: './verordentallerrechazada.html'
})
export class VerOrdenTallerRechazadaComponent implements OnInit {
    verot

    ordentaller = JSON.parse(localStorage['ordenrechazada']) as OrdenTaller;
